...
@onready var __resize_top_right: Control = $Resizers/ResizeTopRight
@onready var __resize_top_left: Control = $Resizers/ResizeTopLeft
@onready var __resize_bottom_left: Control = $Resizers/ResizeBottomLeft
@onready var __resize_bottom_right: Control = $Resizers/ResizeBottomRight
...
func _ready() -> void:
	...
	__resize_bottom_right.gui_input.connect(__handle_input_resize_bottom)
	__resize_bottom_left.gui_input.connect(__handle_input_resize_bottom)
	__resize_top_left.gui_input.connect(__handle_input_resize_top)
	__resize_top_right.gui_input.connect(__handle_input_resize_top)
	

	__resize_bottom_right.gui_input.connect(__handle_input_resize_right)
	__resize_bottom_left.gui_input.connect(__handle_input_resize_left)
	__resize_top_left.gui_input.connect(__handle_input_resize_left)
	__resize_top_right.gui_input.connect(__handle_input_resize_right)
...
func __handle_input_resize_bottom_right(event: InputEvent) -> void:
	if Input.mouse_mode == Input.MOUSE_MODE_CAPTURED:
		return
